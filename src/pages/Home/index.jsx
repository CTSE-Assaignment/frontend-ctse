            ...
            <div className="flex justify-center bg-black-900_63 px-14 py-[227px] md:p-5">
              <div className="mx-auto flex w-full max-w-[1259px] flex-col items-center gap-[60px] sm:gap-[30px]">
                <div className="flex flex-col items-center gap-[15px]">
                  ...
                  <Heading size="lg" as="h1" className="text-center !text-white-A700">
                ...
                <div className="flex flex-col items-start self-stretch rounded-[12px] bg-white-A700_33 p-5">
                  <Button size="xl" className="min-w-[195px] rounded-tl-[12px] rounded-tr-[12px] font-semibold">
                    General Passenger{" "}
                  </Button>
                  <div className="relative mt-[-1px] flex items-center justify-center self-stretch rounded-bl-[12px] rounded-br-[12px] rounded-tr-[12px] bg-white-A700 p-3 md:flex-col">
                    <div className="flex w-[19%] bg-white-A700 p-4 md:w-full md:p-5">
                      <div className="flex w-[78%] flex-col items-start gap-[5px] md:w-full">
                        ...
                        <SelectBox
                          shape="square"
                          indicator={
                            <Img src="images/img_arrowdown.svg" alt="arrow_down" className="h-[20px] w-[20px]" />
                          }
                          name="selectfrom"
                    ...
                    <div className="ml-6 flex w-[48%] items-center gap-6 md:ml-0 md:w-full md:flex-row sm:flex-col">
                      <div className="flex items-start gap-[7px] bg-white-A700 p-[15px]">
                        <Img src="images/img_system_uicons_clock.svg" alt="time_one" className="h-[24px] w-[24px]" />
                        <div className="flex flex-col items-start gap-[5px]">
                          <Heading as="h4" className="text-center">
                            Time
                          </Heading>
                          <div className="flex items-center gap-5 opacity-0.7">
                            <Text size="s" as="p" className="text-center !text-blue_gray-900_cc">
                              Choose Time
                            </Text>
                            <Img src="images/img_arrowdown.svg" alt="choose_time_one" className="h-[20px] w-[20px]" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-1 items-start gap-[7px] rounded-bl-[12px] bg-white-A700 p-4">
                        <Img src="images/img_calendar.svg" alt="calendar_one" className="h-[24px] w-[24px]" />
                        <div className="flex flex-col items-start gap-[5px]">
                          ...
                          <div className="flex items-center gap-5 opacity-0.7">
                            ...
                            <Img src="images/img_arrowdown.svg" alt="arrowdown_one" className="h-[20px] w-[20px]" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="ml-3 flex flex-col items-center justify-center rounded-[12px] bg-orange-600 p-[26px] md:ml-0 md:p-5">
                      <Img src="images/img_search.svg" alt="search_one" className="h-[25px] w-[25px]" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex w-full flex-col gap-4">
                ...
                <div className="flex flex-col items-start gap-[11px]">
                  ...
                  <div className="flex flex-wrap items-start gap-2.5">
                    <Heading as="h3" className="mt-[3px] !text-blue_gray-900_cc">
                      from
                    </Heading>
                    <Heading size="lg" as="h4" className="!font-extrabold !text-orange-600">
                      Colombo Fort
                    </Heading>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <Img src="images/img_calendar_orange_600.svg" alt="every_day_one" className="h-[24px] w-[24px]" />
                    <Heading size="xs" as="h5" className="text-center !text-orange-600">
                      EVERY DAY
                    </Heading>
                  </div>
                  <Text size="s" as="p" className="leading-[26px] !text-blue_gray-900">
                    Badulla is a charming city in the lower central hills of Sri Lanka, where you ...
                  </Text>
                </div>
              </div>
              ...
              <div className="flex w-[50%] flex-col items-start gap-[29px] md:w-full">
                ...
                <div className="flex w-[48%] items-center justify-between gap-5 md:w-full">
                  <div className="flex flex-col items-start gap-0.5">
                    <Heading size="xl" as="h2" className="!font-bold !text-orange-600">
                      12+
                    </Heading>
                    <Text as="p">
                      <>
